    ...
    public partial class intialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "San Francisco", "TechNova Solutions", "415-555-1234", "94107", "CA", "123 Innovation Drive" },
                    { 2, "Seattle", "GreenField Analytics", "206-555-5678", "98101", "WA", "456 Market Street" },
                    { 3, "Denver", "SkyHigh Technologies", "303-555-7890", "80202", "CO", "789 Skyline Blvd" },
                    { 4, "Chicago", "UrbanSoft Inc.", "312-555-4321", "60606", "IL", "321 Downtown Ave" },
                    { 5, "Austin", "NextGen Systems", "512-555-2468", "73301", "TX", "654 Future Lane" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Author", "Category_Id", "Description", "ISBN", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[,]
                {
